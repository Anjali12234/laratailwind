...
<body>
          ...
          <li class='group max-lg:border-b max-lg:py-3 relative'>
            <a href='javascript:void(0)'
              class='hover:text-[#007bff] text-[15px] font-bold lg:hover:fill-[#007bff] block'>Academics<svg
                xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" class="ml-1 inline-block" fill="white"
                viewBox="0 0 24 24">
                <path
                  d="M12 16a1 1 0 0 1-.71-.29l-6-6a1 1 0 0 1 1.42-1.42l5.29 5.3 5.29-5.29a1 1 0 0 1 1.41 1.41l-6 6a1 1 0 0 1-.7.29z"
                  data-name="16" data-original="#000000" />
            ...
            <ul
              ...
              <li class='border-b py-2 '>
                <a href='javascript:void(0)' class='hover:text-[#007bff] text-[15px] font-bold block'>Sale</a>
              </li>
              <li class='border-b py-2 '><a href='javascript:void(0)'
  ...
  <section class="h-screen bg-gray-200">
    <p class="mt-96">Scroll down to see the effect.</p>
  </section>
